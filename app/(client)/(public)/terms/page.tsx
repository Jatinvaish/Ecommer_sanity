  ...
  const termsData = [
    {
      ...
      icon: CheckCircle2,
      content: [
        "By accessing and using Ecommerce&apos;s website and services, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.",
        "These terms constitute a legally binding agreement between you and Ecommerce. If you do not agree with any part of these terms, you must not use our services.",
    ...
    },
    {
      ...
      icon: FileText,
      content: [
        "All content, trademarks, logos, and intellectual property on our website are owned by Ecommerce or our licensors and are protected by copyright and trademark laws.",
        ...
        <Container className="max-w-6xl">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              ...
              outline your rights and responsibilities as a Ecommerce user.
            </p>
            ...
            <Card className="text-center">
              <CardContent className="p-8">
                ...
                <p className="text-sm text-light-text mt-6">
                  ...
                  <a
                    href="mailto:legal@ecommerce.com"
        ...
        <Container className="max-w-4xl">
          <div className="text-center">
            ...
            <p className="text-xs text-light-text">
              By continuing to use Ecommerce, you agree to the most current
