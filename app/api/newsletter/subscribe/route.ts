...
export async function POST(request: NextRequest) {
  try {
    ...
    const emailResult = await sendMail({
      email,
      subject: "Welcome to Ecommerce Newsletter! 🎉",
...
<head>
    ...
    <title>Welcome to Ecommerce Newsletter</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="welcome-message">
                ...
                <p>
                    Thank you for subscribing to the Ecommerce newsletter! We're thrilled to have you as part of our community. 
            ...
            <div class="cta-section">
                ...
                <a href="${
                  process.env.NEXT_PUBLIC_BASE_URL || "https://ecommerce.com"
                }" class="cta-button">
                    Shop Now →
                </a>
            </div>
        ...
        <div class="footer">
            ...
            <div class="unsubscribe">
                <p>
                    You received this email because you subscribed to Ecommerce Newsletter with ${email}.<br>
                    <a href="${
                      process.env.NEXT_PUBLIC_BASE_URL ||
                      "http://jatindevv.netlify.app/"
