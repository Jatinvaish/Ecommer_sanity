...
```bash
NEXT_PUBLIC_COMPANY_NAME=Ecommerce                          # Your company name
NEXT_PUBLIC_COMPANY_EMAIL=support@ecommerce.com             # Main company email
...
```bash
NEXT_PUBLIC_SUPPORT_EMAIL=support@ecommerce.com             # Customer support email
NEXT_PUBLIC_SALES_EMAIL=sales@ecommerce.com                 # Sales team email
```
...
```bash
NEXT_PUBLIC_FACEBOOK_URL=https://facebook.com/ecommerce
NEXT_PUBLIC_TWITTER_URL=https://twitter.com/ecommerce
NEXT_PUBLIC_INSTAGRAM_URL=https://instagram.com/ecommerce
NEXT_PUBLIC_LINKEDIN_URL=https://linkedin.com/company/ecommerce
```

### Legal Pages

```bash
NEXT_PUBLIC_COPYRIGHT_TEXT=© 2024 Ecommerce. All rights reserved.
