...
Successfully implemented a comprehensive user profile system with address management and sophisticated reward/loyalty points system for the Ecommerce application.
