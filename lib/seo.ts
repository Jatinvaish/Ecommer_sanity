...
const BASE_URL = "http://jatindevv.netlify.app/";
...
export function generateCategoryMetadata(
  ...
  const description =
    ...
    `Browse ${productCount} products in ${title} category at Ecommerce. Find the best deals and quality items.`;
...
export function generateProductSchema(product: any) {
  ...
  const brandName =
    typeof product.brand === "object" ? product.brand?.name : "Ecommerce";
...
export function generateHomeMetadata(): Metadata {
  return {
    title: "Ecommerce - Your Trusted Online Shopping Destination",
    description:
      "Discover amazing products at Ecommerce, your trusted online shopping destination for quality items and exceptional customer service. Shop electronics, fashion, home goods and more with fast delivery.",
    keywords: [
      "online shopping",
      "e-commerce",
      "buy online",
    ...
    openGraph: {
      ...
      title: "Ecommerce - Your Trusted Online Shopping Destination",
      description:
        "Discover amazing products at Ecommerce. Shop electronics, fashion, home goods and more with fast delivery.",
      images: [
        {
          url: "/og-image.jpg",
          width: 1200,
          height: 630,
          alt: "Ecommerce Online Store",
        },
      ],
    },
    twitter: {
      ...
      title: "Ecommerce - Your Trusted Online Shopping Destination",
      description:
        "Discover amazing products at Ecommerce. Shop electronics, fashion, home goods and more.",
      images: ["/og-image.jpg"],
    },
    alternates: {
      canonical: BASE_URL,
